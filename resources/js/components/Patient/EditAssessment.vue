<template>
    <div class="modal fade" id="edit-assessment" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Patient Assessment</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-4">
                            ...
                            <multiselect v-model="form.type_of_disease" :options="option_diseases" :multiple="false"
                                ...
                                placeholder="Pick Type of Disease" label="name" track-by="id" :preselect-first="true">
                            </multiselect>
...
export default {
    ...
    methods: {
        create() {
            if (this.deathcheckbox == false && this.form.date_of_death == null) {
                this.form.date_of_death = null; // Clear date if unchecked
            }
            this.form.post('/api/patient/updateassessment/' + this.form.id).then(() => {
                toast.fire({
                    icon: 'success',
                    text: 'Data Saved.',
                })
    ...
    watch: {
        row: function () {
            ...
            this.form.type_of_disease = this.option_diseases.find(
                (disease) => disease.id === this.row.type_of_disease
            );
        },
    },
    mounted() {

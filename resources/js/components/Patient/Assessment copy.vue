<template>
    <div class="modal fade" id="assessment-patient" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Assessment of Patient</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="opacity: 0.5; pointer-events: none;">
                            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-4" style="opacity: 0.5; pointer-events: none;">
    ...
    methods: {
        save() {
            if (this.deathcheckbox == false) {
                ...
                console.log(this.form.date_of_death);
            }
